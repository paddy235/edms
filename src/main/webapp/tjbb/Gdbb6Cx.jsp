  ...
  <body>
	...
	<table class="a11" cellspacing="0" cellpadding="0" border="0" id="GridView1" style="background-color:White;border-width:1px;border-style:solid;width:100%;border-collapse:collapse;color: black; text-decoration: none">
		<tr class="a10" style="color:#002459;">
			<th scope="col">报表年份</th><th scope="col">报表月份</th><th scope="col">编号</th><th scope="col">线别名称</th><th scope="col">段长</th><th scope="col">科长</th><th scope="col">填报人</th><th scope="col">详细</th>
		</tr><tr align="center" style="background-color:#CFDDF0;border-width:1px;border-style:solid;height:24px;">
			<td>2009</td><td>03</td><td>09-001</td><td>武广客专</td><td>雷靠民</td><td>杜悦良</td><td>2009-03-28</td><td align="center">
                            <input type="submit" name="GridView1$ctl02$Button1" value="查看详细" id="GridView1_ctl02_Button1" onclick="window.location.href='Gdbb6Tb.jsp';" class="blueButtonCss2" style="width:60px;" />
                        </td>
		</tr>
	</table>
</div>
