...
<html>
  ...
  <body>
    ...
    <tr><td colspan=2 style="height: 16px">
 		您当前所在的位置：统计报表---->牵引供电设备运行概况表（机电报表1）
    </td></tr>
    <tr height="10"></tr>
    <tr height="30">
<td  align="right">
	...
	<option value="12">12</option>
        ...
        <input type="submit" name="Button2" value="生成报表" id="Button2" onclick="window.location.href='Gdbb1Tb.jsp';" class="blueButtonCss" />
        </td>
      <td  align="right">
</td></tr> 
        <tr><td colspan="2">
	...
	<table class="a11" cellspacing="0" cellpadding="0" border="0" id="GridView1" style="background-color:White;border-width:1px;border-style:solid;width:100%;border-collapse:collapse;color: black; text-decoration: none">
		<tr class="a10" style="color:#002459;">
			...
			<td>2009</td><td>03</td><td>雷靠民</td><td>杜悦良</td><td>2009-03-28</td><td align="center"><input type="button" value="查看详细"  onclick="window.location.href='Gdbb1Tb.jsp';" class="blueButtonCss2" style="width:60px;" /></td>
			<td align="center">
