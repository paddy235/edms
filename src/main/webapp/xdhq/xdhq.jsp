...
<html>
  <head>  
    ...
    <title>铁路供电调度管理指挥系统--行调会签和设备监控</title>
    <!-- ExtJS所用 -->	
...
%>  
 <script language="JavaScript">  
  ...
  <body>
     ...
     <script type="text/javascript" src="xdhq.js"></script>
     <div id="HqJkTabs">
       <div id="Xdhq" class="x-hide-display"></div>
       <div id="Sbjk" class="x-hide-display"></div>
     </div>
  </body>
</html>
