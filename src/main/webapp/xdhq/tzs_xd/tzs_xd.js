Ext.onReady(function() {
	...
	var whereclause_init="ZT=1 and a.XDTDM LIKE '"+DWDM+"%'";
	// alert(whereclause_init);
    var store = new Ext.data.Store({
        //proxy告诉我们从哪里获得数据
        proxy: new Ext.data.HttpProxy({url:'tzs_xd_json.jsp'}),        
        //reader告诉我们如何解析这个数据
        baseParams:{whereclause:whereclause_init},
