...
<html>
  <head>  
    <!--<meta http-equiv="refresh" content="10; url=xdhq.jsp">-->
    
    <title>铁路供电调度管理指挥系统--行调会签</title>
    <!-- ExtJS所用 -->	
...
%>  
 <script language="JavaScript">  
         var yh='<%=(String)session.getAttribute("YHMC")%>';
  </SCRIPT>
  <body>
     ...
     <script type="text/javascript" src="xdhq2.js"></script>
     <div id="sound" style="position:absolute;left:0px;top:0px;z-index:20;display:none" >
