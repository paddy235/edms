                                          ...
                                          if (simpleForm_Query.form.isValid()) {
                                               var where=" and 1=1 ";
													...
													if(Ext.getCmp("txt_ksrq").getValue()!="" ){
														where=where+" and jssj >=to_date('"+Ext.getCmp("txt_ksrq").getValue()+"','yyyy-mm-dd hh24:mi')";	
													}
													if(Ext.getCmp("txt_jsrq").getValue()!="" ){
														where=where+"  and jssj <=to_date('"+Ext.getCmp("txt_jsrq").getValue()+"','yyyy-mm-dd hh24:mi')";	
													}
