...
<html>
   ...
   <%
     ...
     String userdwid="";
     String isdd="";
	 //System.out.println("userdwid"+session.getAttribute("DWDM").toString());
	...
	for(int i=0;ROLE!=null&&i<ROLE.size();i++){
		...
		if(qx.equalsIgnoreCase("APPROVE")){
			APPROVE=true;
			break;
		}
	} 	
    ...
    %>
  	...
  	<body>
         ...
         <script type="text/javascript" src="tzgl_qy_cx.js"></script>   
	</body>
</html>
