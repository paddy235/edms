                                   ...
                                   handler : function() {
                                          ...
                                          //alert(Ext.getCmp("txt_ksrq").getValue());
                                                if(Ext.getCmp("txt_ksrq").getValue()!="" ){
														where=where+" and jbsj >=to_date('"+Ext.getCmp("txt_ksrq").getValue()+"','yyyy-mm-dd hh24:mi')";	
													}
													 //alert(Ext.getCmp("txt_jsrq").getValue());
													if(Ext.getCmp("txt_jsrq").getValue()!="" ){
														where=where+"  and jbsj <=to_date('"+Ext.getCmp("txt_jsrq").getValue()+"','yyyy-mm-dd hh24:mi')";	
													}
