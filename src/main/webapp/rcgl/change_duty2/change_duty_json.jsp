...
try {
	...
	String sql_Query_count="select count(*) from z_yxgl_jjbjl2 where "+whereclause;
	...
	String sql_Query="select * from (select rownum xh,temp.* from (select * from z_yxgl_jjbjl2 where "+ whereclause +" order by jbsj desc) temp) where xh between "+ (index+1) +" and "+ (pageSize + index);
