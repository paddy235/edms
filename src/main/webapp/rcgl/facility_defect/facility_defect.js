Ext.onReady(function() {
   ...
   var planRecord_bdtall = Ext.data.Record.create([
    ...
    var columns = new Ext.grid.ColumnModel([
        ...
        {header:'单位名称',dataIndex:'dwmc',width:80,fixed:true,sortable:true},
		{header:'发现时间',dataIndex:'fxsj',width:120,fixed:true,sortable:true},
        {header:'发现人',dataIndex:'fkr',width:60,fixed:true,sortable:true},
        {header:'设备名称',dataIndex:'sbmc',width:80,sortable:true},

        {header:'缺陷内容',dataIndex:'qxnr',width:120,sortable:true},
                                   ...
                                   handler : function() {
                                          ...
                                          if (simpleForm_Query.form.isValid()) {
                                                  ...
                                                  if(Ext.getCmp("txt_ksrq").getValue()!="" ){
														where=where+" and qx.fxsj >=to_date('"+Ext.getCmp("txt_ksrq").getValue()+"','yyyy-mm-dd hh24:mi')";	
													}
													 //alert(Ext.getCmp("txt_jsrq").getValue());
													if(Ext.getCmp("txt_jsrq").getValue()!="" ){
														where=where+"  and qx.fxsj <=to_date('"+Ext.getCmp("txt_jsrq").getValue()+"','yyyy-mm-dd hh24:mi')";	
													}
