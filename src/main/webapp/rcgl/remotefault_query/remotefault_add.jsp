...
<%
    ...
    try {
        String sql_insert = "insert into Z_XXGX_YDGZBG(YDSGBM,YDBGBH,BGSJ,GQPYM,BHZZDM,GZMS,SGJL,TZYY,CHZZT,FHSJ,TDSF,LB,BZ,DDY,bhzzmc , kgh) values(YDGZBGSEQ.Nextval,'',to_date('" + bgsj
