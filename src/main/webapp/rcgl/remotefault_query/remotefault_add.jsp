...
try {
   String sql_insert="insert into Z_XXGX_YDGZBG(YDSGBM,YDBGBH,BGSJ,GQPYM,BHZZDM,GZMS,SGJL,TZYY,SJGZDD,CHZZT,FHSJ,TDSF,LB,BZ,DDY,xb,bhzzmc,kgh,tdqd,shr) values(get_ydgzbgbm(YDGZBGSEQ.Nextval),'',to_date('"+bgsj
   +"','yyyy-mm-dd hh24:mi:ss'),'"+gqpym+"','1','"+gzms+"','"+sgjl+"','"+tzyy+"','"+sjgzdd+"','"+chzzt+"',to_date('"+fhsj+"','yyyy-mm-dd hh24:mi:ss'),'"+tdsf+"','"+lb+"','"+bz+"','"+ddy+"','"+xb+"','"+bhzzdm_mc+"','"+kgh+"','"+tdqd+"','"+shr+"')";
