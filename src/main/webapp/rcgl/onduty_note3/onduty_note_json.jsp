...
//        whereclause_onduty = " 1=1 ";
    ...
    try {
        ...
        String sql_Query_count = "select count(*) from z_yxgl_zbjs3 where " + whereclause_onduty;
        ...
        String sql_Query = "select * from (select rownum xh,temp.* from (select * from z_yxgl_zbjs3 where " + whereclause_onduty + " order by jssj desc) temp) where xh between " + (index + 1) + " and " + (pageSize + index);
