   ...
   var dich=" 1=1";
 	 ...
 	 var renderYuanneirong =function(value)
 	 {
 	    //var url = 'ShowGzzd.jsp?id='+value;
 	 	//alert("sdfsdfsdf");
  	    return '<a href="fbt\\'+value+'" target="view_window">查看详细</a>';
 	 }; 	 
    ...
    var columns = new Ext.grid.ColumnModel([
        ...
        //{header:'编号',dataIndex:'id',width:35,fixed:true},  
       	{header:'抢修材料分布名称',dataIndex:'ZYZDSMC',width:360,fixed:true,sortable:true},
        ...
        items : [{
                	...
                	items:[{xtype:'hidden',name:'id',id:'xiu_id'},
                	{
                		...
                		items: [{
                    		xtype:'textfield',
                    		fieldLabel: '材料分布',
                    		blankText : '材料分布',// 提交form时，该项如果没有选择，则提示错误信息"请选择学历
                	...
                	items:[ 
                	{
                		...
                		items: [{
            				...
            				emptyText: '请选择材料分布',
           					fieldLabel: '材料分布',
            				name: 'GZZDLJ',
            				blankText : '须材料分布',// 提交form时，该项如果没有选择，则提示错误信息"请选择学历
                    		allowBlank : false,// 该选项值不允许为空
            				buttonText: '',
            				buttonCfg: {
                				iconCls: 'upload-icon'
