...
<html>
     ...
     <%  String yanr= (String)session.getAttribute("yanr"); 
         session.removeAttribute("yanr");
       %>	
      <script type="text/javascript" src="qxyacx.js"></script>   
      <script type="text/javascript" src="yanr.js"></script>
  	<body> 		 
  		  
  	       
       <% if (yanr != null){             
       out.print("<div id=\"win\" class=\"x-hidden\" >");
       out.print("<p>"); %>   
       <%= yanr %>
       <% out.print("</div>");
       } %>
