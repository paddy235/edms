   ...
   var dich=" 1=1";
    ...
    var columns = new Ext.grid.ColumnModel([
        ...
        //{header:'编号',dataIndex:'id',width:35,fixed:true},  
       	{header:'工区分布图名称',dataIndex:'ZYZDSMC',width:360,fixed:true,sortable:true},
        ...
        items : [{
                	...
                	items:[{xtype:'hidden',name:'id',id:'xiu_id'},
                	{
                		...
                		items: [{
                    		xtype:'textfield',
                    		fieldLabel: '工区分布',
                    		blankText : '工区分布',// 提交form时，该项如果没有选择，则提示错误信息"请选择学历
                	...
                	items:[ 
                	{
                		...
                		items: [{
            				...
            				emptyText: '请选择工区分布',
           					fieldLabel: '工区分布',
            				name: 'GZZDLJ',
            				blankText : '须工区分布',// 提交form时，该项如果没有选择，则提示错误信息"请选择学历
                    		allowBlank : false,// 该选项值不允许为空
            				buttonText: '',
            				buttonCfg: {
                				iconCls: 'upload-icon'
