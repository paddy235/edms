   ...
   var dich=" 1=1";
 	 ...
 	 var renderYuanneirong =function(value)
 	 {
 	    //var url = 'ShowGzzd.jsp?id='+value;
 	 	//alert("sdfsdfsdf");
  	    return '<a href="bdt\\'+value+'" target="view_window">查看详细</a>';
 	 }; 	 
    ...
    var columns = new Ext.grid.ColumnModel([
        ...
        //{header:'编号',dataIndex:'id',width:35,fixed:true},  
       	{header:'机具布点图名称',dataIndex:'ZYZDSMC',width:360,fixed:true,sortable:true},
        ...
        items : [{
                	...
                	items:[{xtype:'hidden',name:'id',id:'xiu_id'},
                	{
                		...
                		items: [{
                    		xtype:'textfield',
                    		fieldLabel: '机具布点图',
                    		blankText : '机具布点图',// 提交form时，该项如果没有选择，则提示错误信息"请选择学历
                	...
                	items:[ 
                	{
                		...
                		items: [{
            				...
            				emptyText: '请选择机具布点图',
           					fieldLabel: '机具布点图',
            				name: 'GZZDLJ',
            				blankText : '须作业机具布点图',// 提交form时，该项如果没有选择，则提示错误信息"请选择学历
                    		allowBlank : false,// 该选项值不允许为空
            				buttonText: '',
            				buttonCfg: {
                				iconCls: 'upload-icon'
