    ...
    try {
        ...
        while (gridResultSet.next()) {
            ...
            json += "{SDTZBH:" + gridResultSet.getLong("SDTZBH") +
                    ...
                    ",SJC:'" + ("9".equals(zt) ? CheckSting(gridResultSet.getString("SDSJC")) : "") + "'" +
                    ",ZT:'" + CheckSting(zt) + "'},";
        }
