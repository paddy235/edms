               ...
               handler : function() {
                    ...
                    if (simpleForm_Query.form.isValid()) {
						...
						if(Ext.getCmp("ksrq").getValue()!="" ){
							where=where+" and trunc(TDSJ)>=to_date('"+Ext.util.Format.date(Ext.getCmp("ksrq").getValue(), 'Y-m-d')+"','yyyy-mm-dd')";	
						}
						if(Ext.getCmp("jsrq").getValue()!="" ){
							where=where+" and trunc(TDSJ)<=to_date('"+Ext.util.Format.date(Ext.getCmp("jsrq").getValue(), 'Y-m-d')+"','yyyy-mm-dd')";	
						}
