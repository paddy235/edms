...
try {
	...
	String sql_Query="select * from (select rownum xh,temp.* from (select t.*,to_char(t.TSDRQ,'yyyy-mm-dd') TSDRQ1,to_char(t.LD_TDQZSJ,'yyyy-mm-dd hh24:mi') LD_TDSJ,to_char(t.LD_TDQZSJ1,'yyyy-mm-dd hh24:mi') LD_SDSJ,to_char(t.SD_SF,'yyyy-mm-dd hh24:mi') SD_SF1 from Z_TJBB_TSDDJB t where "+ whereclause +" order by TSDRQ desc,zt) temp) where xh between "+ (index+1) +" and "+ (pageSize + index);
