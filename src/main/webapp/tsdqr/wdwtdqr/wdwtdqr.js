Ext.onReady(function() {
    ...
    //alert("aaa");
 	...
 	//渲染返回html代码
 	 ...
 	 {
 	     return '<a  href="wdwtdqr_del.jsp?tdqrid='+value+'">删除</a>';
 	 };
    ...
    var columns = new Ext.grid.ColumnModel([
        ...
        {header:'停电ID',dataIndex:'tdqrid',width:15},
        {header:'停电时间',dataIndex:'tdsj',width:25,sortable:true},
        {header:'停电情况',dataIndex:'tdqk',width:50,sortable:true},
        {header:'完成情况',dataIndex:'wcqk',width:50,sortable:true},
        {header:'神朔电调',dataIndex:'ssdd',width:90,fixed:true},
        {header:'外单位',dataIndex:'wdw',width:120,fixed:true},
        {header:'外单位调度员',dataIndex:'wdwddy',width:90,fixed:true},
        {header:'删除',dataIndex:'tdqrid',width:60,renderer:renderDel,fixed:true}
    ]);
