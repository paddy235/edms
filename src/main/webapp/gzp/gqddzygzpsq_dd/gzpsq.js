Ext.onReady(function() {
	...
	{//alert("jhlb:"+jhlb);
      if(jhlb=="0")//停电作业 绿色
		...
		{
			gzpurl="../ticket/operationTicket_red_dd.jsp?jhlb="+jhlb+"&jhid="+jhid;//添加工作票
		    gzpXx="../ticket/operationTicket_red_look_dd.jsp?jhlb="+jhlb+"&id=";//查看工作票
		    gzpDel="../ticket/gzp_gq_redDel_dd.jsp?jhlb="+jhlb+"&jhid="+jhid+"&id=";//删除工作票
		     gzpSb="../ticket/gzp_gq_redSb.jsp?jhlb="+jhlb+"&jhid="+jhid+"&id=";//删除工作票
		}
		else//远离作业 黑色
		{
    ...
    var columns = new Ext.grid.ColumnModel([
       ...
       // {header:'出工人数',dataIndex:'cgrs',width:40},
        ...
        {header:'工作票状态',dataIndex:'gzpzt',width:60,renderer:zt,sortable:true,hidden:true},
