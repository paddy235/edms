Ext.onReady(function() {
	...
	if(dwlb=="1")//判断是网工区
	{
		if(jhlb=="0")//停电作业 绿色
		{
		   ...
		   gzpSp="../ticket_sp/operationPlan_Electric_look.jsp?id=";//审批工作票
	...
	else//判断是变电所
	{
		if(jhlb=="0")//停电作业 绿色
		{
		  gzpSp="../ticket_sp/operationPlan_Electric_look.jsp?id=";//查看工作票
		...
		{
			 gzpSp="../ticket/operationTicket_Electric_red.jsp?id=";//查看工作票
		}
	}
