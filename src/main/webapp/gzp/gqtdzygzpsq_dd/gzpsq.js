Ext.onReady(function() {
	...
	if(dwlb=="1")//判断是网工区
	{
      if(jhlb=="0")//停电作业 绿色
		{
		   gzpurl="../ticket/operationTicket_dd.jsp?jhid="+jhid+"&jhlb="+jhlb;//添加工作票
		  
		   gzpXx="../ticket/operationTicket_look_dd.jsp?jhlb="+jhlb+"&id=";//查看工作票
		   gzpDel="../ticket/gzp_gq_greenDel_dd.jsp?jhlb="+jhlb+"&jhid="+jhid+"&id=";//删除工作票
