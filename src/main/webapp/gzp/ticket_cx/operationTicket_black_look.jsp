...
<html>
  <head>
	...
	<link rel="stylesheet" href="/edms/yxgl/ticket/css/calendar-skin.css" type="text/css"></link>
	  <link rel="stylesheet" href="/edms/yxgl/ticket/css/Bdsgzpblack.css" type="text/css"></link>
  <link rel="stylesheet" href="/edms/yxgl/ticket/css/calendar-skin.css" type="text/css"></link>
...
<body scroll="yes">
	 <form action="gzp_gq_blackUpdate.jsp" name="Register" method="post">
	   <%
														...
														<TR>
															<TD style="HEIGHT: 21px" align=left>
																<INPUT class=TextUnderCss id=txtdwbm
																	style="WIDTH: 141px" readOnly value="<%=resultSet.getString("dwmc") %>"
																	name=txtdwbm>
															</TD>
...
<INPUT class=blueButtonCss id=btnDY onclick="window.location.href='../../tjbb/query/gq_black.jsp?gzpid=<%=id %>'";
