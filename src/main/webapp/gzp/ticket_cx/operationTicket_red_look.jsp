																			...
																			<TR>
																				...
																				<TD style="WIDTH: 98px; HEIGHT: 26px" align=left colSpan=3>
																					<INPUT class=TextUnderCss id=txtFPRQ
																						style="WIDTH: 142px" onclick="showcalendar(this,true)" value="<%=gettime(resultSet.getDate("fpsj"))%>"
																						name=txtFPRQ>
																			...
																			<TR>
																				...
																				<TD style="HEIGHT: 26px" align=left colSpan=6>
																					...
																					<INPUT class=TextUnderCss id=txtYXQS
																						style="WIDTH: 146px" onclick="showcalendar(this,true)" value="<%=gettime(resultSet.getDate("t_yxsj"))%>"
																						name=txtYXQS>
																					至
																					<INPUT class=TextUnderCss id=txtYXQZ
																						style="WIDTH: 146px" onclick="showcalendar(this,true)" value="<%=gettime(resultSet.getDate("e_yxsj"))%>"
																						name=txtYXQZ>
																					止
																				</TD>
																			</TR>
