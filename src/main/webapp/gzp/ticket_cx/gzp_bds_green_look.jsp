											...
											<TR>
												...
												<TD style="WIDTH: 375px; HEIGHT: 20px" align=left colSpan=5>
													<INPUT class=TextUnderCss name="txtZYDDNR"
														style="WIDTH: 440px; HEIGHT: 32px" value="<%=resultSet.getString("zynr") %>" >
											...
											<TR>
												...
												<TD style="WIDTH: 375px; HEIGHT: 39px" align=left colSpan=5>
													...
													<INPUT class=TextUnderCss id=txtLDRXM
														style="WIDTH: 151px"  value="<%=resultSet.getString("gzldr") %>" name=LDRXM>
													<SPAN id=ldrmessage
														style="DISPLAY: none; COLOR: red">工作领导人不能为空！</SPAN> 安全等级:
													<INPUT class=TextUnderCss id=inputLDRJB value="<%=resultSet.getString("ldrdj") %>" maxLength=1 size=4
														name=LDRJB>
...
<INPUT class=blueButtonCss id=btnDY onclick="window.location.href='../../tjbb/query/bds_green.jsp?gzpid=<%=id %>'";
