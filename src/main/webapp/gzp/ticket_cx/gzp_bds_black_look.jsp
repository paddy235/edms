...
<html>
 ...
 <BODY  scroll="yes">
<form action="gzp_bds_blackSp.jsp" name="Register" method="post">
	   <%
...
border=1>
        ...
        <TR>
          ...
          <TD style="WIDTH: 98px" align=left><INPUT class=TextUnderCss 
            id=txtLDRJB maxLength=4 size=5 value="<%=SetNull(resultSet.getString("ldrdj")) %>" name=txtLDRJB> <SPAN 
        ...
        <TR>
          <TD class=td1 align=right colSpan=5>值班员<INPUT class=TextUnderCss2 
            ...
            value="<%=SetNull(resultSet.getString("zyzbyqz")) %>" name=txtZBY> <SPAN id=txtZBY_dlshow 
            style="DISPLAY: none; Z-INDEX: 1; VERTICAL-ALIGN: bottom; CURSOR: hand; POSITION: relative"><SELECT 
        ...
        <TR>
          <TD class=td1 align=right colSpan=5>工作领导人<INPUT class=TextUnderCss2 
            ...
            value="<%=SetNull(resultSet.getString("ksgzldrqz")) %>" name=txtGZLDR> <SPAN id=txtGZLDR_dlshow 
            style="DISPLAY: none; Z-INDEX: 1; VERTICAL-ALIGN: bottom; CURSOR: hand; POSITION: relative"><SELECT 
        ...
        <TR>
          <TD class=td1 style="HEIGHT: 21px" align=left 
            ...
            style="WIDTH: 400px" maxLength=100 value="<%=SetNull(resultSet.getString("zyrybgjl")) %>" name=txtBGJL></TD></TR>
        <TR>
        ...
        <TR>
          <TD class=td1 style="HEIGHT: 18px" align=right colSpan=3>发票人<INPUT 
            ...
            value="<%=SetNull(resultSet.getString("bgfprqz")) %>" name=txtBGFBR> <SPAN 
            id=txtBGFBR_dlshow 
            style="DISPLAY: none; Z-INDEX: 1; VERTICAL-ALIGN: bottom; CURSOR: hand; POSITION: relative"><SELECT 
          ...
          <TD class=td1 style="HEIGHT: 18px" align=right colSpan=5>工作领导人<INPUT 
            ...
            value="<%=SetNull(resultSet.getString("bgldrqz")) %>" name=txtBGLDR> <SPAN 
            id=txtBGLDR_dlshow 
            style="DISPLAY: none; Z-INDEX: 1; VERTICAL-ALIGN: bottom; CURSOR: hand; POSITION: relative"><SELECT 
        ...
        <TR>
          ...
          <TD class=td1 style="HEIGHT: 25px" align=right colSpan=2>工作领导人<INPUT 
            class=TextUnderCss2 id=txtJSLDR_txtTitle style="WIDTH: 80px" 
             value="<%=SetNull(resultSet.getString("jsldrqz")) %>" name=txtJSLDR> <SPAN 
            id=txtJSLDR_dlshow 
            style="DISPLAY: none; Z-INDEX: 1; VERTICAL-ALIGN: bottom; CURSOR: hand; POSITION: relative"><SELECT 
        ...
        <TR>
          <TD class=td1 align=right colSpan=5>值班员<INPUT class=TextUnderCss2 
            ...
            value="<%=SetNull(resultSet.getString("zbyqz")) %>" name=txtZYQLZBY> </TD></TR></TBODY></TABLE></DIV><SPAN id=Label1></SPAN><BR>
      <TABLE WIDTH="100%">
        <TBODY>
    							<tr>
								<td align="right">
									...
									<input type="hidden" value="<%=id%>" name="gzpid" />
											 <INPUT class=blueButtonCss id=btnDY onclick="window.location.href='../../tjbb/query/bds_black.jsp?gzpid=<%=id %>'";
													style="WIDTH: 93px" type=button value="打印" name=btnDY>
