Ext.onReady(function() {
    ...
    djch=djch+"and YXQS <=sysdate and YXQS>=to_date('"+getTime()+"','yyyy-mm-dd hh24:mi')";
	...
	var zt =function (value)
 	...
 	//渲染返回html代码
 	 var renderXiangxi =function(value)
 	 {
         ...
         gzpXx="../ticket_cx/dzgzp_look.jsp?id=";//查看工作票
                                          ...
                                          if (simpleForm_Query.form.isValid()) {
                                                  var where="1=1";
                                                    if(Ext.getCmp("txt_ksrq").getValue()!="" ){
														where=where+" and YXQS >=to_date('"+Ext.getCmp("txt_ksrq").getValue()+"','yyyy-mm-dd hh24:mi')";	
													}
													if(Ext.getCmp("txt_jsrq").getValue()!="" ){
														where=where+"  and YXQS <=to_date('"+Ext.getCmp("txt_jsrq").getValue()+"','yyyy-mm-dd hh24:mi')";	
													}
