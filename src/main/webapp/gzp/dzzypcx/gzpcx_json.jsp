...
try {
	...
	String sql_Query="select * from (select rownum xh,temp.* from (select * from "+table+" where "+ whereclause +" order by YXQS desc) temp) where xh between "+ (index+1) +" and "+ (pageSize + index);
