...
try {
	...
	String sql_Query_count="select count(*) from "+table;//+" ;where gzpzt='1' and jhid= "+jhid;
	...
	String sql_Query="select * from (select rownum xh,temp.* from (select * from "+table+") temp) where xh between "+ (index+1) +" and "+ (pageSize + index);
