...
<html>
 ...
 <BODY>
<form action="gzp_BdsblackUpdate_dd.jsp" name="Register" method="post">
  <%
...
<TABLE>
  ...
  <TR>
    <TD style="HEIGHT: 21px" align=left><INPUT class=TextUnderCss id=txtDWBM 
      style="WIDTH: 141px"   size=10 value="<%=resultSet.getString("dwmc") %>" name=txtDWBM><SPAN 
...
border=1>
        ...
        <TR>
          ...
          <TD align=right colspan="6">共计<INPUT class=TextUnderCss id=cyTotal 
           size=10 value="<%=resultSet.getString("cgrs")%> " name=cyTotal>人
