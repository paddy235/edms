...
if(session.getAttribute("userDwid")==null||session.getAttribute("ddtmc")==null||session.getAttribute("ddtmc")==null)
{
	...
	String dwmc =request.getParameter("txtDWBM");
	...
	String sql = "insert into z_yxgl_gzpbds_black values(z_yxgl_gzpbds_blacksq.nextval,'"
			...
			+ "','yyyy-mm-dd hh24:mi'),'"+jhid+"','停电作业','100','0','"+ZYDDNR+"','"+WLLDRXM+"','"+BDSJHR+"','"+BDSJHR+"','"+BGFBR1+"','"+AQCS1+"','"+YZAQCS1+"')";
	...
	dbconn.executeUpdate(sql);
        ...
        //关闭数据库连接
        dbconn.close();
		response.sendRedirect("../bdsdszgzpsq_dd/gzpsq.jsp?myid=" + jhid + "&jhtype=" + jhtype); 
%>
