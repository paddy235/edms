...
<html>
	...
	<body scroll="yes">
	  <form action="gzp_gq_greenUpdate_dd.jsp" name="Register" method="post">
	  <%
														...
														<TBODY>
															<TR>
																...
																<TD style="HEIGHT: 26px" align=left colSpan=3>
																	<INPUT class="TextUnderCss" style="WIDTH: 200px" 
																...
																<TD style="HEIGHT: 26px" align=left colSpan=2>
																	<INPUT class=TextUnderCss id=txtFPR
																		style="WIDTH: 140px" maxLength=5 value="<%=resultSet.getString("fpr") %>" name=txtFPR>
															...
															<TR>
																...
																<TD style="WIDTH: 66px; HEIGHT: 14px" align=left  colSpan=2>
																...
																<TD style="WIDTH: 98px; HEIGHT: 14px" align=left colSpan=2>
																	<INPUT class=TextUnderCss id="txtLDRJB"
																		style="WIDTH: 101px"   value="<%=resultSet.getString("ldrdj") %>" name="txtLDRJB">
																</TD>
															</TR>
																   ...
																   <td><INPUT class=TextUnderCss id=txtCJGBSJ
																    ...
																    <td align=center>时间</td>
																     <td><INPUT class=TextUnderCss id=txtDDSJ
																		style="WIDTH: 110px; HEIGHT: 30px" value="<%=convertDate(resultSet.getDate("DDSJ"))+" "+convertTime(resultSet.getTime("DDSJ"))%>" onclick="showcalendar(this,true)" name=txtDDSJ></td> 
															</tr>
