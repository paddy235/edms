...
<%
   ...
   String sql="delete z_yxgl_gzpbds_black where gzpid="+gzpid;
   String sql_zyry="delete z_yxgl_zyry where ryb='bds_black'  and  gzpid="+gzpid;
   ...
   if(dbTrade.executeUpdate(sql))
   {
      ...
      dbTrade.close();
      dbtrade1.close();
      response.sendRedirect("../bdsdszgzpsq_dd/gzpsq.jsp?myid=" + jhid
				+ "&jhtype=" + jhtype);
   }
