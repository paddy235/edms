...
<html>
 ...
 <BODY>
<form action="gzp_Bds_blackSave_dd.jsp" name="Register" method="post">
...
<TABLE>
  ...
  <TR>
    <TD style="HEIGHT: 21px" align=left><INPUT class=TextUnderCss id=txtDWBM 
      style="WIDTH: 141px"   size=10  name=txtDWBM><SPAN 
...
border=1>
        ...
        <TR>
          ...
          <TD style="HEIGHT: 21px" align=left cls><INPUT class=TextUnderCss 
            id=cy2_txtTitle style="WIDTH: 70px"  value="" onblur="allnum()"
            name=cy2>  
          <TD style="HEIGHT: 21px" align=left><INPUT class=TextUnderCss 
            id=cy3_txtTitle style="WIDTH: 70px" onblur="allnum()" 
            name=cy3> <SPAN 
            id=cy3_RequiredFieldValidator1 
            style="DISPLAY: none; COLOR: red"></SPAN>  </TD>
          <TD style="HEIGHT: 21px" align=left><INPUT class=TextUnderCss 
            id=cy4_txtTitle style="WIDTH: 70px"  onblur="allnum()"
            ...
            id=cy5_txtTitle style="WIDTH: 70px"  onblur="allnum()"
        ...
        <TR>
          <TD align=left><INPUT class=TextUnderCss id=cy6_txtTitle 
            style="WIDTH: 70px" name=cy6 onblur="allnum()"> <SPAN 
            id=cy5_dlshow 
            style="DISPLAY: none; Z-INDEX: 1; VERTICAL-ALIGN: bottom; CURSOR: hand; POSITION: relative"><SELECT 
            id=cy5_DDLTitle onblur=hiddeDl(this) style="WIDTH: 70px" 
          ...
          <TD align=left><INPUT class=TextUnderCss id=cy9_txtTitle onblur="allnum()" 
            style="WIDTH: 70px"  name=cy9> <SPAN 
            id=cy8_dlshow 
            style="DISPLAY: none; Z-INDEX: 1; VERTICAL-ALIGN: bottom; CURSOR: hand; POSITION: relative"> </SPAN><SPAN 
            ...
            style="WIDTH: 70px"  name=cy10> <SPAN 
            id=cy8_dlshow 
            style="DISPLAY: none; Z-INDEX: 1; VERTICAL-ALIGN: bottom; CURSOR: hand; POSITION: relative"> </SPAN><SPAN 
            id=cy8_RequiredFieldValidator1 
            style="DISPLAY: none; COLOR: red"></SPAN>  <SPAN 
        ...
        <TR>
          <TD style="HEIGHT: 21px" align=left><INPUT class=TextUnderCss 
            id=cy11_txtTitle style="WIDTH: 70px" onblur="allnum()"
            name=cy11> <SPAN id=cy9_dlshow 
            style="DISPLAY: none; Z-INDEX: 1; VERTICAL-ALIGN: bottom; CURSOR: hand; POSITION: relative"><SELECT 
            id=cy9_DDLTitle onblur=hiddeDl(this) style="WIDTH: 70px" 
            onchange=addTxtTanto(this,this.options[this.selectedIndex].innerText,false) 
            ...
            style="DISPLAY: none; COLOR: red">作业组成员等级要求至少为2！</SPAN> </TD>
          <TD style="HEIGHT: 21px" align=left><INPUT class=TextUnderCss 
            id=cy12_txtTitle style="WIDTH: 70px"  onblur="allnum()"
            name=cy12> <SPAN id=cy10_dlshow 
            style="DISPLAY: none; Z-INDEX: 1; VERTICAL-ALIGN: bottom; CURSOR: hand; POSITION: relative"><SELECT 
            id=cy10_DDLTitle onblur=hiddeDl(this) style="WIDTH: 70px" 
            onchange=addTxtTanto(this,this.options[this.selectedIndex].innerText,false) 
            ...
            style="DISPLAY: none; COLOR: red">作业组成员等级要求至少为2！</SPAN> </TD>
          <TD style="HEIGHT: 21px" align=left><INPUT class=TextUnderCss 
            id=cy13_txtTitle style="WIDTH: 70px" onblur="allnum()"
            name=cy13> <SPAN id=cy11_dlshow 
            style="DISPLAY: none; Z-INDEX: 1; VERTICAL-ALIGN: bottom; CURSOR: hand; POSITION: relative"><SELECT 
            id=cy11_DDLTitle onblur=hiddeDl(this) style="WIDTH: 70px" 
            onchange=addTxtTanto(this,this.options[this.selectedIndex].innerText,false) 
            ...
            style="DISPLAY: none; COLOR: red">作业组成员等级要求至少为2！</SPAN> </TD>
          <TD style="HEIGHT: 21px" align=left><INPUT class=TextUnderCss 
            id=cy14_txtTitle style="WIDTH: 70px" onblur="allnum()"
            ...
            style="DISPLAY: none; COLOR: red">作业组成员等级要求至少为2！</SPAN> </TD>
             <TD style="HEIGHT: 21px" align=left colSpan=2><INPUT class=TextUnderCss 
            id=cy15_txtTitle style="WIDTH: 70px" onblur="allnum()"
        ...
        <TR>
          ...
          <TD align=right colspan="6">共计<INPUT class=TextUnderCss id=cyTotal 
            maxLength=100  value="" name=cyTotal>人
