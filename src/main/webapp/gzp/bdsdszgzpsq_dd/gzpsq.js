Ext.onReady(function() {
	...
	else//判断是变电所
	{
	  if(jhlb=="0")//停电作业 绿色
		...
		{
			gzpurl="../ticket/operationTicket_Electric_black_dd.jsp?jhlb="+jhlb+"&jhid="+jhid;//添加工作票
			gzpXx="../ticket/operationTicket_Electric_black_look_dd.jsp?jhlb="+jhlb+"&id=";//查看工作票
			//gzpXx="../ticket/bds_black_look.jsp";//查看工作票
		    gzpDel="../ticket/gzp_Bds_blackDel_dd.jsp?jhlb="+jhlb+"&jhid="+jhid+"&id=";//删除工作票
		}
	}
