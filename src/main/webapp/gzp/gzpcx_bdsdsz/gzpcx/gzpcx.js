Ext.onReady(function() {
    ...
    { //alert(userdj);
       djch=" gzpzt!=0 and dwid in(select gq.gqdm from j_gyjc_gqzd gq where gq.ddtdm like "+"'"+dwid+"%')";
       djch2=" gzpzt!=0 and dwid in(select gq.gqdm from j_gyjc_gqzd gq where gq.ddtdm like "+"'"+dwid+"%')";
    ...
    var columns = new Ext.grid.ColumnModel([
        ...
        {header:'作业单位',dataIndex:'dwmc',width:80,fixed:true,sortable:true},
