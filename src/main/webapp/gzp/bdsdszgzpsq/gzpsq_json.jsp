...
try {
	...
	String sql_Query_count="select count(*) from "+table  +" where gzpzt='0' and dwid='"+gqid+"'";
	...
	String sql_Query="select * from (select rownum xh,temp.* from (select * from "+table+" where  dwid='"+gqid+"' order by gzpid desc) temp) where xh between "+ (index+1) +" and "+ (pageSize + index);
   ...
   // System.out.pringln();
    while(gridResultSet.next()){
		json += "{xh:" +gridResultSet.getLong("xh")  + 
        		...
        		",zynr:'"+ gridResultSet.getString("ZYDDJNR")+"'"+
