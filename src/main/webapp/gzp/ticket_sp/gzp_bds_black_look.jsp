...
<TABLE>
  ...
  <TR>
    ...
    第<INPUT class=TextUnderCss id=txtGZPH style="WIDTH: 60px" 
      value="<%=SetNull(resultSet.getString("gzph")) %>" name=txtGZPH>号</TD></TR>
  <TR>
...
border=1>
        ...
        <TR>
          ...
          <TD align=left colSpan=4><INPUT class=TextUnderCss id=txtZYDDNR 
            style="WIDTH: 410px" maxLength=100 value="<%=SetNull(resultSet.getString("zyddjnr")) %>"
        ...
        <TR>
          ...
          <TD style="WIDTH: 98px" align=left>&nbsp;<INPUT class=TextUnderCss2 
            ...
            value="<%=SetNull(resultSet.getString("fpr")) %>"name=txtFBR>  </TD></TR>
        <TR>
