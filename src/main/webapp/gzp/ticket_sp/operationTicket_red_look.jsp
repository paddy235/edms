...
<html>
	...
	<body scroll="yes">
	 <form action="gzp_gq_redSp.jsp" name="Register" method="post">
	   <%
												...
												<TABLE id=browseTable>
													<TBODY>
																			...
																			<TR>
																				...
																				<TD style="WIDTH: 98px; HEIGHT: 26px" align=left colSpan=3>
																					<INPUT class=TextUnderCss id=txtFPRQ
																						style="WIDTH: 142px" onclick="showcalendar(this,true)" value="<%=gettime(resultSet.getDate("fpsj"))+" "+convertTime(resultSet.getTime("fpsj"))%>"
																						name=txtFPRQ>
															...
															<tr>
																<TD style="WIDTH: 200px" align=center>
																 ...
																 <td align=left>	<INPUT class=TextUnderCss id=txtAQYSJ
																		style="WIDTH: 110px; HEIGHT: 30px" value="<%=convertDate(resultSet.getDate("AQYSJ"))+" "+convertTime(resultSet.getTime("AQYSJ"))%>"  onclick="showcalendar(this,true)" name=txtAQYSJ>
																</td>
																  <td align=center>时间</td>
																   <td><INPUT class=TextUnderCss id=txtCJGBSJ
																		style="WIDTH: 110px; HEIGHT: 30px" onclick="showcalendar(this,true)" value="<%=convertDate(resultSet.getDate("CJGBSJ"))+" "+convertTime(resultSet.getTime("CJGBSJ"))%>" name=txtCJGBSJ></td>
																    <td align=center>时间</td>
																     <td><INPUT class=TextUnderCss id=txtDDSJ
																		style="WIDTH: 110px; HEIGHT: 30px" value="<%=convertDate(resultSet.getDate("DDSJ"))+" "+convertTime(resultSet.getTime("DDSJ"))%>" onclick="showcalendar(this,true)" name=txtDDSJ>
																		<div style="display:none; color:green;" id="ddmesage">电调、时间不能空</div>
																			...
																			<TR>
																				...
																				<TD style="HEIGHT: 10px" align=left colSpan=6>
																					<INPUT class=TextUnderCss id=txtGZPJSSJ
																						style="WIDTH: 283px; HEIGHT: 30px" value="<%=gettime(resultSet.getDate("jssj")) %>" onclick="showcalendar(this,true)" name=txtGZPJSSJ>
																				</TD>
																			</TR>
																			<TR>
																				<TD style="WIDTH: 200px; HEIGHT: 10px">
														...
														<TR>
															...
															<input type="hidden" value="1111" name="del"/>
<INPUT class=blueButtonCss  style="WIDTH: 93px" type=button onclick="registerSubmit()"  value="通过" />
												<INPUT class=blueButtonCss  style="WIDTH: 93px" type=button onclick="registerSubmit1()"  value="不通过" />
