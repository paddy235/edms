	...
	<BODY>
	   ...
	   %>
          ...
          <TD style="WIDTH: 100px" align=left><INPUT class=TextUnderCss 
            id=txtWLLDRXM_txtTitle style="WIDTH: 50px"  value="<%=SetNull(resultSet.getString("WLLDRXM")) %>" name=txtWLLDRXM><SPAN id=ldrmessage style="DISPLAY: none; COLOR: red">工作领导人不能为空！</SPAN> </TD>
          <TD style="WIDTH: 100px">安全等级</TD>
          <TD style="WIDTH: 98px" align=left colSpan=3><INPUT class=TextUnderCss value="<%=SetNull(resultSet.getString("WLLDRXMDJ")) %>"
														...
														<TBODY>
															...
															<TR>
																<TD align=right colSpan=2 rowSpan=2>
																	...
																	<INPUT class=TextUnderCss2 value="<%=SetNull(resultSet.getString("BDJHR1")) %>" 
																		style="WIDTH: 74px"
																		 name=txtBDSJHR2>（签字） 
															...
															<TR>
																<TD style="HEIGHT: 25px" align=right colSpan=2 rowSpan=2>
																	...
																	<INPUT class=TextUnderCss2 id=txtYCLDR_txtTitle value="<%=SetNull(resultSet.getString("ycgzldrqz")) %>"
																		...
																		变电所监护人
																	<INPUT class=TextUnderCss2 value="<%=SetNull(resultSet.getString("BDJHR2")) %>" 
																		style="WIDTH: 74px"
																		 name=txtBDSJHR3>（签字） 
