Ext.onReady(function() {
	...
	if(dwlb=="1")//判断是网工区
	{
      if(jhlb=="0")//停电作业 绿色
		{
		   gzpurl="../ticket/dzgzp.jsp?jhid="+jhid+"&jhlb="+jhlb;//添加工作票
		   gzpXx="../ticket_sp/dzgzp_look.jsp?jhlb="+jhlb+"&id=";//查看工作票
		   gzpDel="../ticket/gzp_gq_greenDel.jsp?jhlb="+jhlb+"&jhid="+jhid+"&id=";//删除工作票
		   gzpSb="../ticket/gzp_gq_greenSb.jsp?jhlb="+jhlb+"&jhid="+jhid+"&id=";//删除工作票
		}
	...
	//alert(jhid+"  "+jhlb);
 	...
 	//渲染返回html代码
 	 ...
 	 var renderXiangxi =function(value)
 	 {
 	     ...
 	     return '<a href="'+gzpXx+value+'">审批</a>';
    ...
    var columns = new Ext.grid.ColumnModel([
        ...
        {header:'状态',dataIndex:'gzpzt',width:60,renderer:zt,sortable:true},
    ...
    var store = new Ext.data.Store({
        //proxy告诉我们从哪里获得数据
        proxy: new Ext.data.HttpProxy({url:'dzzysp_json.jsp?jhid='+jhid+'&jhlb='+jhlb+'&dwlb='+dwlb+'&gqid='+gqid+'&dwid='+dwid}),      
        //reader告诉我们如何解析这个数据
