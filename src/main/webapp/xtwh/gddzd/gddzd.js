Ext.onReady(function() {
    ...
    //alert("aaa");
 	...
 	//渲染返回html代码
 	 ...
 	 {
 	     return '<a  href="gddzd_del.jsp?GDDDM='+value+'">删除</a>';
 	 };
    ...
    var columns = new Ext.grid.ColumnModel([
        ...
        {header:'运输段代码',dataIndex:'GDDDM',width:50},
        {header:'运输段简称',dataIndex:'GDDJC',width:50,sortable:true},
        {header:'运输段名称',dataIndex:'GGDMC',width:60,sortable:true},
        {header:'运输段电话',dataIndex:'GGDDH',width:60,sortable:true},
        {header:'运输段传真',dataIndex:'GDDCZ',width:60,sortable:true},
        {header:'运输段地址',dataIndex:'GDDDZ',width:110,sortable:true},
        {header:'所属公司',dataIndex:'LJQC',width:60,sortable:true},
        {header:'运输段拼音码',dataIndex:'DPYM',width:60,sortable:true},
        {header:'经度',dataIndex:'JD',width:50,sortable:true},
        {header:'纬度',dataIndex:'WD',width:50,sortable:true},
        {header:'删除',dataIndex:'GDDDM',width:60,renderer:renderDel,fixed:true}
    ]);
              ...
              items : [{
                       ...
                       items : [{
                                            ...
                                            items : [{
									            	...
									            	blankText : '请选择运输段代码',// 提交form时，该项如果没有选择，则提示错误信息"请选择学历"
									            	emptyText : '选择运输段代码',// 在没有选择值时显示为选择学历
									            	hiddenName : 'GDDDM',// 大家要注意的是hiddenName和name属性，name只是下拉列表的名称，作用是可通过，而hiddenName才是提交到后台的input的name。如果没有设置hiddenName，在后台是接收不到数据的，这个大家一定要注意。
									            	editable : true,// 该下拉列表只允许选择，不允许输入
									            	triggerAction : 'all',// 因为这个下拉是只能选择的，所以一定要设置属性triggerAction为all，不然当你选择了某个选项后，你的下拉将只会出现匹配选项值文本的选择项，其它选择项是不会再显示了，这样你就不能更改其它选项了。
									            	//allowBlank : false,// 该选项值不允许为空
									            	fieldLabel : '运输段代码',// 控件的标题是学历
									            	name : 'GDDDM',// 再次提醒，name只是下拉列表的名称
									            	id:'gdd_id',
