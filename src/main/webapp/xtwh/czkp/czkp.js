Ext.onReady(function() {
    ...
    //alert("aaa");
 	...
 	//渲染返回html代码
 	 ...
 	 {
 	     return '<a  href="czkp_del.jsp?KPID='+value+'">删除</a>';
 	 };
    ...
    var columns = new Ext.grid.ColumnModel([
        ...
        {header:'单位ID',dataIndex:'DWID',width:8},
        //{header:'单位名称',dataIndex:'DWMC',width:17},
        {header:'卡片编号',dataIndex:'KPBH',width:5},
        {header:'卡片名称',dataIndex:'KPMC',width:20},
        {header:'卡片内容',dataIndex:'KPNR',width:60},
        {header:'删除',dataIndex:'KPID',width:60,renderer:renderDel,fixed:true}
    ]);
