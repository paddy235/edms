Ext.onReady(function() {
    ...
    //alert("aaa");
 	...
 	//渲染返回html代码
 	 ...
 	 {
 	     return '<a  href="bhzzlx_del.jsp?BHZZLXBM='+value+'">删除</a>';
 	 };
    ...
    var columns = new Ext.grid.ColumnModel([
        ...
        {header:'保护装置类型编码',dataIndex:'BHZZLXBM',width:60},
        {header:'维保护装置类型名称',dataIndex:'BHZZLXMC',width:60,sortable:true},
        {header:'删除',dataIndex:'BHZZLXBM',width:60,renderer:renderDel,fixed:true}
    ]);
   
    
    var planRecord = Ext.data.Record.create([
    	{name:'BHZZLXBM',type:'string'},
    	{name:'BHZZLXMC',type:'string'}
    	]);
    ...
    var store = new Ext.data.Store({
        //proxy告诉我们从哪里获得数据
        proxy: new Ext.data.HttpProxy({url:'bhzzlx_json.jsp'}),        
        //reader告诉我们如何解析这个数据
                     ...
                     simpleForm_Save.form.doAction('submit', {
                                                                      ...
                                                                      success : function(form, action) {
                                                                             ...
                                                                             Ext.Msg.alert('操作',action.result.data);
                                                                      		Ext.Msg.alert('消息',action.result.msg);
                                                                      		simpleForm_Query.form.reset();
                                                                      		 window.location.href='bhzzlx.jsp';
                                                                      		simple_Grid.getStore().reload();
