Ext.onReady(function() {
    ...
    //alert("aaa");
 	...
 	//渲染返回html代码
 	 ...
 	 {
 	     return '<a  href="wxxm_del.jsp?id='+value+'">删除</a>';
 	 };
    ...
    var columns = new Ext.grid.ColumnModel([
        ...
        {header:'维修项目ID',dataIndex:'ID',width:60},
        {header:'维修项目名称',dataIndex:'NAME',width:60,sortable:true},
    ...
    var store = new Ext.data.Store({
        //proxy告诉我们从哪里获得数据
        proxy: new Ext.data.HttpProxy({url:'wxxm_json.jsp'}),  
    ...
    var my_wxxm="";
    	...
    	my_wxxm=Ext.getCmp("WX_ID").getValue();
    	Ext.getCmp("WX_ID").disable();
    });	
              ...
              buttons : [{
	                       ...
	                       handler : function() {
	                              ...
	                              if (simpleForm_Query.form.isValid()) {
										...
										var where="1=1 ";										
										if(Ext.getCmp("wid").getValue()!="" ){
											where=where+" and ID like '%"+Ext.getCmp("wid").getValue()+"%'";
										}
										if(Ext.getCmp("wname").getValue()!="" ){
											where=where+" and NAME like'%"+Ext.getCmp("wname").getValue()+"%'";	
										}
