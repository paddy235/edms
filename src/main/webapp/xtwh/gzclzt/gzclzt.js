Ext.onReady(function() {
    ...
    //alert("aaa");
 	...
 	//渲染返回html代码
 	 ...
 	 {
 	     return '<a  href="gzclzt_del.jsp?ID='+value+'">删除</a>';
 	 };
    ...
    var columns = new Ext.grid.ColumnModel([
        ...
        {header:'故障处理状态ID',dataIndex:'ID',width:60},
        {header:'故障处理状态名称',dataIndex:'NAME',width:60,sortable:true},
    ...
    var store = new Ext.data.Store({
        //proxy告诉我们从哪里获得数据
        proxy: new Ext.data.HttpProxy({url:'gzclzt_json.jsp'}),        
        //reader告诉我们如何解析这个数据
                     ...
                     simpleForm_Save.form.doAction('submit', {
                                                                      ...
                                                                      success : function(form, action) {
                                                                             ...
                                                                             Ext.Msg.alert('操作',action.result.data);
                                                                      		Ext.Msg.alert('消息',action.result.msg);
                                                                      		simpleForm_Query.form.reset();
                                                                      		 window.location.href='gzclzt.jsp';
                                                                      		simple_Grid.getStore().reload();
