Ext.onReady(function() {
    ...
    //alert("aaa");
 	...
 	//渲染返回html代码
 	 ...
 	 {
 	     return '<a  href="ddzd_del.jsp?DDDM='+value+'">删除</a>';
 	 };
    ...
    var columns = new Ext.grid.ColumnModel([
        ...
        {header:'电调代码',dataIndex:'DDDM',width:40},
        {header:'电调简称',dataIndex:'DDJC',width:50,sortable:true},
        {header:'电调名称',dataIndex:'DDMC',width:80,sortable:true},
        {header:'电调电话',dataIndex:'DDDH',width:60,sortable:true},
        {header:'电调传真',dataIndex:'DDCZ',width:60,sortable:true},
        {header:'电调地址',dataIndex:'DDDZ',width:120,sortable:true},
        ...
        {header:'删除',dataIndex:'DDDM',width:60,renderer:renderDel,fixed:true}
    ]);
              ...
              items : [{
                                   ...
                                   items : [{
                                                        ...
                                                        items : [{
										                        	...
										                        	blankText : '请选择供电调代码',// 提交form时，该项如果没有选择，则提示错误信息"请选择学历"
										                        	emptyText : '选择供电调代码',// 在没有选择值时显示为选择学历
										                        	...
										                        	fieldLabel : '电调代码',// 控件的标题是学历
										                        	name : 'DDDM',// 再次提醒，name只是下拉列表的名称
										                        	id:'dd_id',
										                        	anchor : '65%'// input的宽度是90%
										    					}]
                                                 },{
                                                        columnWidth : .3,
                                                        layout : 'form',
                                                        ...
                                                        items : [{
										                        	...
										                        	mode : 'local',// 数据是在本地
										                        	//forceSelection : true,// 必须选择一个选项
										                        	blankText : '请选择供电调名称',// 提交form时，该项如果没有选择，则提示错误信息"请选择学历"
										                        	emptyText : '选择供电调名称',// 在没有选择值时显示为选择学历
										                        	hiddenName : 'DDMC',// 大家要注意的是hiddenName和name属性，name只是下拉列表的名称，作用是可通过，而hiddenName才是提交到后台的input的name。如果没有设置hiddenName，在后台是接收不到数据的，这个大家一定要注意。
										                        	editable : true,// 该下拉列表只允许选择，不允许输入
										                        	triggerAction : 'all',// 因为这个下拉是只能选择的，所以一定要设置属性triggerAction为all，不然当你选择了某个选项后，你的下拉将只会出现匹配选项值文本的选择项，其它选择项是不会再显示了，这样你就不能更改其它选项了。
										                        	//allowBlank : false,// 该选项值不允许为空
										                        	fieldLabel : '电调名称',// 控件的标题是学历
										                        	name : 'DDMC',// 再次提醒，name只是下拉列表的名称
										                        	id:'dd_mc',
