Ext.onReady(function() {
    ...
    //alert("aaa");
 	...
 	//渲染返回html代码
 	 ...
 	 {
 	     return '<a  href="sbfl_del.jsp?SBFLID='+value+'">删除</a>';
 	 };
    ...
    var columns = new Ext.grid.ColumnModel([
        ...
        {header:'设备类型代码',dataIndex:'SBFLID',width:60},
        {header:'设备类型名称',dataIndex:'SBFLNAME',width:60,sortable:true},
        {header:'删除',dataIndex:'SBFLID',width:60,renderer:renderDel,fixed:true}
    ]);
              ...
              items : [{
                                   ...
                                   items : [{
                                                        ...
                                                        items : [{
									                        	...
									                        	blankText : '请选择设备类型',// 提交form时，该项如果没有选择，则提示错误信息"请选择学历"
									                        	emptyText : '选择设备类型',// 在没有选择值时显示为选择学历
									                        	hiddenName : 'SBFLID',// 大家要注意的是hiddenName和name属性，name只是下拉列表的名称，作用是可通过，而hiddenName才是提交到后台的input的name。如果没有设置hiddenName，在后台是接收不到数据的，这个大家一定要注意。
									                        	editable : true,// 该下拉列表只允许选择，不允许输入
									                        	triggerAction : 'all',// 因为这个下拉是只能选择的，所以一定要设置属性triggerAction为all，不然当你选择了某个选项后，你的下拉将只会出现匹配选项值文本的选择项，其它选择项是不会再显示了，这样你就不能更改其它选项了。
									                        	//allowBlank : false,// 该选项值不允许为空
									                        	fieldLabel : '属性类型',// 控件的标题是学历
									                        	name : 'SBFLID',// 再次提醒，name只是下拉列表的名称
									                        	id:'sb_id',
