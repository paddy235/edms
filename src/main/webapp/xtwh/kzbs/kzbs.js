Ext.onReady(function() {
    ...
    //alert("aaa");
 	...
 	//渲染返回html代码
 	 ...
 	 {
 	     return '<a  href="kzbs_del.jsp?id='+value+'">删除</a>';
 	 };
    ...
    var columns = new Ext.grid.ColumnModel([
        ...
        {header:'扩展标识代码',dataIndex:'ID',width:60},
        {header:'线别名称',dataIndex:'MC',width:60,sortable:true},
    ...
    var store = new Ext.data.Store({
        //proxy告诉我们从哪里获得数据
        proxy: new Ext.data.HttpProxy({url:'kzbs_json.jsp'}),        
        //reader告诉我们如何解析这个数据
