...
String zt="2";
if(userDwid.equalsIgnoreCase("021")){
	zt="3";
}
...
try {
	...
	String sql_Query_count="select count(*) from z_yxgl_zyjh jh,J_gyjc_xlzd xb,J_GDGY_SXZD jhlx,(select gqzd.gqdm from J_GYJC_GQZD gqzd where ddtdm like '"+userDwid+"%' and (jglbdm='1' or jglbdm='2'))  gq  where "+whereclause;
	...
	String sql_Query="select * from (select rownum xh,temp.* from (select jh.*,xb.xlm,jhlx.sxmc from z_yxgl_zyjh jh,J_gyjc_xlzd xb,J_GDGY_SXZD jhlx,(select gqzd.gqdm from J_GYJC_GQZD gqzd where ddtdm like '"+userDwid+"%' and (jglbdm='1' or jglbdm='2'))  gq   where "+ whereclause +") temp) where xh between "+ (index+1) +" and "+ (pageSize + index);
