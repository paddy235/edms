...
//这是一段写死的临时代码，通过单位代码021，判断该用户是电调主任，更新ddzr字段，否则更新spr字段
String userDwid="";
String spr="spr='"+username+"'";
...
+"',bz='"+bz+"',"+spr+",zt=zt+1,mlh='"+mlh+"',ylz='"+ylz+"',fsfw='"+fsfw+"',jhnr='"+jhnr+"',gdcnr='"+gdcnr+"' where id='"+id+"'";
