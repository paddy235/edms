Ext.onReady(function() {
    ...
    //alert(userDwid);
 	...
 	//渲染返回html代码
 	 ...
 	 var zt =function (value)
 	 {
  		...
  		if (value=='4')  {return '<div  style="color:red;">待值班主任审批</div>';}
  	    if(value=="5")	 {return '<div  style="color:555800;">待归档</div>';}	
    ...
    var store = new Ext.data.Store({
        //proxy告诉我们从哪里获得数据 
        proxy: new Ext.data.HttpProxy({url:'zyjhsp_json.jsp?type=sp'}),        
        //reader告诉我们如何解析这个数据
