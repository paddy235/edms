...
try {
	...
	String sql_Query="select * from (select rownum xh,temp.* from (select * from Z_JCSJ_GZZD where "+ whereclause +" order by ID desc) temp) where xh between "+ (index+1) +" and "+ (pageSize + index);
