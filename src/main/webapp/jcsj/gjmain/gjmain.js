    ...
    */
    //渲染返回html代码
 	 ...
 	 //定义Grid表头
        ...
        {header:'工具编号',dataIndex:'ccxh',sortable:true},
        {header:'工具名称',dataIndex:'sbflname',sortable:true},
        {header:'数量',dataIndex:'sl',sortable:true},
        {header:'单位',dataIndex:'dw',width:80,sortable:true},
        {header:'所属单位',dataIndex:'gqmc',width:160,sortable:true},
        ...
        items : [{
                	...
                	items:[{xtype:'hidden',name:'id'},{xtype:'hidden',name:'albm'},{
                		...
                		items: [{
                        	...
                        	mode : 'local',// 数据是在本地
                        	//forceSelection : true,// 必须选择一个选项
                        	blankText : '请选工具名称',// 提交form时，该项如果没有选择，则提示错误信息"请选择学历"
                        	emptyText : '选择工具名称',// 在没有选择值时显示为选择学历
                	...
                	items:[{
                		...
                		items: [{
                    		...
                    		format:'Y-m-d',
                    		allowBlank : false,
                    		blankText : '请选日期',// 提交form时，该项如果没有选择，则提示错误信息"请选择学历"
                        	emptyText : '选择日期',// 在没有选择值时显示为选择学历
    						timePicker:true
    					}]
                	}]
                },{
