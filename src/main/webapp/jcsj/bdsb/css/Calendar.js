...
// $Id: Calendar.js,v 1.1 2006/12/01 08:42:19 administrator Exp $
...
//============================
 function showcalendar(dateEl,showtime) {
...
function getCurrentlyDate(object,object1,object2,object3,object4,object5){
	if(object!=null&&object!=""&&object!="undefined")
		object.value = new Date().format('yyyy-MM-dd');
	if(object1!=null&&object1!=""&&object1!="undefined")
		object1.value = new Date().format('yyyy-MM-dd');
	if(object2!=null&&object2!=""&&object2!="undefined")
		object2.value = new Date().format('yyyy-MM-dd');
	if(object3!=null&&object3!=""&&object3!="undefined")
		object3.value = new Date().format('yyyy-MM-dd');
	if(object4!=null&&object4!=""&&object4!="undefined")
		object4.value = new Date().format('yyyy-MM-dd');
	if(object5!=null&&object5!=""&&object5!="undefined")
		object5.value = new Date().format('yyyy-MM-dd');
}