	...
	<body>
		<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
				...
				<TR>
					<TD style="HEIGHT: 24px">
						&nbsp;您现在所在位置: 首页--&gt; 基础数据 --&gt;抗雷圈</TD>
				</TR>
				<TR>
					<TD class=tableHeadText style="HEIGHT: 5px" align=middle>抗雷圈</TD>
				</TR>
				<TR>
		...
		<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=1 >
							<TR>
							    ...
							    <INPUT class=grayinput id=DwRy2_txtTitle  value="抗雷圈"  name=DwRy2$txtTitle>								</TD>
			...
			<TR>
				...
				<td colspan="1" style="PADDING-LEFT: 5px"><select><option>ＡＢＢ</option><option>国营红旗机械厂</option><option>湖南科明电源有限公司</option></select></td>
			...
			<TR>
				...
				<td colspan="4" style="PADDING-LEFT: 5px"><INPUT class=grayinput value="抗雷臂、抗雷线圈"   name=DwRy2$txtTitle></td>
			</TR>
			<tr>
