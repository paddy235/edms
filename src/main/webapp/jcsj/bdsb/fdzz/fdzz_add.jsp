	...
	<body>
		<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
				...
				<TR>
					<TD style="HEIGHT: 24px">
						&nbsp;您现在所在位置: 首页--&gt; 基础数据 --&gt;放电装置</TD>
				</TR>
				<TR>
					<TD class=tableHeadText style="HEIGHT: 5px" align=middle>放电装置</TD>
				</TR>
				<TR>
		...
		<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=1 >
							<TR>
							    ...
							    <INPUT class=grayinput id=DwRy2_txtTitle  value="放电设备"  name=DwRy2$txtTitle>								</TD>
			...
			<TR>
				<TD>主要部件构成：				</TD>
				<TD style="PADDING-LEFT: 5px" align=left colSpan=2>
									 <INPUT class=grayinput id=DwRy2_txtTitle  value="放电臂、放电线圈"  name=DwRy2$txtTitle>						  </TD>
				<td colspan="1">单位：</td>
				...
				<td colspan="1" style="PADDING-LEFT: 5px"><select><option>丹东长兴电器有限公司 </option><option>国营红旗机械厂</option><option>湖南科明电源有限公司</option></select></td>
			...
			<TR>
				...
				<td colspan="2" style="PADDING-LEFT: 5px"><INPUT class=grayinput value="放电设备"   name=DwRy2$txtTitle></td>
				<TD>年度：				</TD>
				
				<td colspan="1" style="PADDING-LEFT: 5px"><INPUT class=grayinput value="2008"   name=DwRy2$txtTitle></td>
				<TD>主要部件：				</TD>
				
				<td colspan="4" style="PADDING-LEFT: 5px"><INPUT class=grayinput value="放电臂、放电线圈"   name=DwRy2$txtTitle></td>
			</TR>
			<tr>
