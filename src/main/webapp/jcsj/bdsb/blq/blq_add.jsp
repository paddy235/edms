	...
	<body>
		<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
				...
				<TR>
					<TD style="HEIGHT: 24px">
						&nbsp;您现在所在位置: 首页--&gt; 基础数据 --&gt;避雷器</TD>
				</TR>
				<TR>
					<TD class=tableHeadText style="HEIGHT: 5px" align=middle>避雷器</TD>
				</TR>
				<TR>
		...
		<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=1 >
							<TR>
							    ...
							    <select><option>阀型避雷器</option><option>氧化锌避雷器</option><option>其它</option></select>								</TD>
				...
				<TD style="PADDING-LEFT: 5px" align=left >
						...
						<TR>
								<TD>套管材质：</TD>
          						<TD style="PADDING-LEFT: 5px" align=left colSpan=2>
									 <select><option>复合</option><option>瓷质</option></select>										</TD>
								<TD>高度：</TD>
          						<TD style="PADDING-LEFT: 5px" align=left colSpan=1>
									 <INPUT class=grayinput id=DwRy2_txtTitle  value="14.5"  name=DwRy2$txtTitle>								</TD>
								
							  <TD>类别：				</TD>
				<TD style="PADDING-LEFT: 5px" align=left ><INPUT class=grayinput id=DwRy2_txtTitle  value="27.5kv"  name=DwRy2$txtTitle>		
														  </TD>
			...
			<TR>
				<TD>主要部件构成：				</TD>
				<TD style="PADDING-LEFT: 5px" align=left colSpan=2>
									 <INPUT class=grayinput id=DwRy2_txtTitle  value="避雷器、避雷塔座"  name=DwRy2$txtTitle>						  </TD>
				<td colspan="1">单位：</td>
				...
				<td colspan="1" style="PADDING-LEFT: 5px"><select><option>法国阿尔斯通公司</option><option>日本东芝株式会社</option><option>上海阿海珐变压器有限公司</option></select></td>
			...
			<TR>
				...
				<td colspan="4" style="PADDING-LEFT: 5px"><INPUT class=grayinput value="避雷器、接地引线"   name=DwRy2$txtTitle></td>
			</TR>
			<tr>
