	...
	<body>
		<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
				...
				<TR>
					<TD style="HEIGHT: 24px">
						&nbsp;您现在所在位置: 首页--&gt; 基础数据 --&gt;高压柜 </TD>
				</TR>
				<TR>
					<TD class=tableHeadText style="HEIGHT: 5px" align=middle>高压柜 </TD>
				</TR>
				<TR>
		...
		<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=1 >
							<TR>
								...
								<TD width=10%>设备分类：								</TD>
								<TD colSpan=1 style="PADDING-LEFT: 5px"> <select><option>10KV高压柜</option><option>27.5KV高压柜</option></select></TD>
				...
				<TD style="PADDING-LEFT: 5px" align=left >
							  ...
							  <TD>主要部件构成：				</TD>
				<TD style="PADDING-LEFT: 5px" align=left >
									 <INPUT class=grayinput id=DwRy2_txtTitle  value="高压盘组、柜组"  name=DwRy2$txtTitle>							  </TD>
							</TR>
							
                       	<tr>
							<TD>单位：				</TD>
				            <TD style="PADDING-LEFT: 5px" align=left colSpan=2>
									 <INPUT class=grayinput id=DwRy2_txtTitle  value="面"  name=DwRy2$txtTitle>							  </TD>
							<td>生产厂家：</td>
			...
			<TR>
				...
				<td colspan="4" style="PADDING-LEFT: 5px"><INPUT class=grayinput value="高压盘柜"   name=DwRy2$txtTitle></td>
				<TD>主要部件：				</TD>
