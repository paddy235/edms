...
//得到主键
	try 
	{
   		sql="select max(id) maxid from z_jcsj_bdglkg";
		...
		//插入数据
		sql="insert into z_jcsj_bdglkg(id,szdw,bm,zw,zy,xm,gh,xb,jg,mz,hkxz,csd,csrq,sfzh,whcd,zzmm,hyzk,gz,aqdj,ydsgdj,jsdj,bc) values('"
