...
try {
	...
	String sql_Query_count="select count(*) from J_GYJC_YH a where "+whereclause;
	...
	String sql_Query="select * from (select rownum xh,temp.* from (select a.*, b.dwmc from J_GYJC_YH a,v_j_gyjc_yhdw b where "+whereclause+" and a.dwdm=b.dwdm order by YHMC) temp) where xh between "+ (index+1) +" and "+ (pageSize + index);
   ...
   //System.out.println("kjshoie");
    ...
    while(gridResultSet.next()){
		...
		json += "{YHDM:'" +gridResultSet.getString(2)+"'" +
        		...
        		",BZ:'"+(gridResultSet.getString(12)==null?"":gridResultSet.getString(12)).replaceAll("\\r\\n","\\\\r\\\\n")+"'"+
        		",DDTDM:'"+(gridResultSet.getString(13)==null?"":gridResultSet.getString(13))+"'"+
        		",DWMC:'"+(gridResultSet.getString(14)==null?"":gridResultSet.getString(14))+"'"+
