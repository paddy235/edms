...
//得到主键
	try 
	{
   		sql="select max(id) maxid from Z_JCSJ_FHKG";
		...
		//插入数据
		sql="insert into Z_JCSJ_FHKG(id,szdw,bm,zw,zy,xm,gh,xb,jg,mz,hkxz,csd,csrq,sfzh,whcd,zzmm,hyzk,gz,aqdj,ydsgdj,jsdj,bc) values('"
