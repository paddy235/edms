...
try {
    DbTrade db_connection=new DbTrade();
		String sql_Upd="update z_jcsj_ry set szdw='"+szdw+"',bm='"+bm+"',zw='"+zw+"',zy='"+zy+"',xm='"+xm+"',gh='"+gh+"',xb='"+xb+"',csrq=to_date('"+csrq+"','yyyy-MM-dd'),jg='"+jg+"',mz='"+mz+"',hkxz='"+hkxz+"',csd='"+csd+"',sfzh='"+sfzh+"',whcd='"+whcd+"',zzmm='"+zzmm+"',hyzk='"+hyzk+"',gz='"+gz+"',aqdj='"+aqdj+"',ydsgdj='"+ydsgdj+"',jsdj='"+jsdj+"',bc='"+bc+"' where id='"+id+"'";	
