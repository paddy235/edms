...
//得到主键
	try 
	{
   		sql="select max(id) maxid from z_jcsj_JYQ";
    	...
    	sql="INSERT INTO Z_JCSJ_JYQ( ID ,XCBH ,QJZC ,XBBM ,SXXBM ,SBLX,SBXH ,SBCZ ,ZZH ,GLB ,SCRQ ,TYRQ ,SCCJ ) VALUES ("+maxid+",'"+XCBH+"','"+QJZC+"','"+XBBM+"','"+SXXBM+"','"+SBLX+"','"+SBXH+"','"+SBCZ+"','"+ZZH+"','"+GLB+"',to_date('"+SCRQ+"','yyyy-MM-dd'),"+"to_date('"+TYRQ+"','yyyy-MM-dd'),'"+SCCJ+"')";
