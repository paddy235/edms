    ...
    */
	...
	var expander = new Ext.ux.grid.RowExpander({
 	 ...
 	 // select ID,SCBH,QJZC,XBBM,SXXBM,SBLX,SBXH,SBCZ,ZZH,SCRQ,TYRQ,SCCJ,GLB from Z_JCSJ_XC
        ...
        {header:'绝缘器编号',dataIndex:'XCBH',sortable:true,width:120,sortable:true},
        ...
        {header:'绝缘器类型',dataIndex:'SBLX',sortable:true,width:120,sortable:true}, 
	 ...
	 var store = new Ext.data.Store({
     	//proxy告诉我们从哪里获得数据
     	proxy: new Ext.data.HttpProxy({url:'jyqlist.jsp'}),        
     	//reader告诉我们如何解析这个数据
                ...
                
                {
                	...
                	items:[{
                		...
                		items: [{
                        	...
                        	mode : 'local',// 数据是在本地
                        	//forceSelection : true,// 必须选择一个选项
                        	blankText : '请选择绝缘器类型',// 提交form时，该项如果没有选择，则提示错误信息"请选择学历"
                        	emptyText : '选择绝缘器类型',// 在没有选择值时显示为选择学历
