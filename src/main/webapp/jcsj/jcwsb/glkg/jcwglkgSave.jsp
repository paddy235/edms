...
//得到主键
	try 
	{
   		sql="select max(id) maxid from z_jcsj_JCWGLKG";
    	...
    	sql="INSERT INTO Z_JCSJ_JCWGLKG ( ID ,XCBH ,QJZC ,XBBM ,SXXBM ,SBLX,SBXH ,SBCZ ,ZZH ,GLB ,SCRQ ,TYRQ ,SCCJ ) VALUES ("+maxid+",'"+XCBH+"','"+QJZC+"','"+XBBM+"','"+SXXBM+"','"+SBLX+"','"+SBXH+"','"+SBCZ+"','"+ZZH+"','"+GLB+"',to_date('"+SCRQ+"','yyyy-MM-dd'),"+"to_date('"+TYRQ+"','yyyy-MM-dd'),'"+SCCJ+"')";
