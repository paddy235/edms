    ...
    */
	...
	var expander = new Ext.ux.grid.RowExpander({
 	 ...
 	 // select ID,SCBH,QJZC,XBBM,SXXBM,SBLX,SBXH,SBCZ,ZZH,SCRQ,TYRQ,SCCJ,GLB from Z_JCSJ_XC
        ...
        {header:'隔离开关编号',dataIndex:'XCBH',sortable:true,width:120,sortable:true},
        {header:'区间站场',dataIndex:'QJZC',sortable:true},
        {header:'线别',dataIndex:'XBBM',sortable:true},
        {header:'上下行',dataIndex:'SXXBM',sortable:true,width:40,sortable:true}, 
        {header:'隔离开关类型',dataIndex:'SBLX',sortable:true,width:120,sortable:true}, 
        {header:'是否带接地刀闸',dataIndex:'SBXH',sortable:true,width:120,sortable:true},
       	{header:'是否带流互',dataIndex:'SBCZ',sortable:true,width:120,sortable:true},
            ...
            items : [{
              ...
              items: [{
                        	...
                        	store : new Ext.data.SimpleStore({
                        		...
                        		data : [['', '全部'],['长沙站', '长沙站'],['长沙-湘潭', '长沙-湘潭'], ['湘潭站', '湘潭站'],['武南-南湖区间', '武南-南湖区间'],['南湖站', '南湖站'], ['南湖-流芳区间', '南湖-流芳区间']]}),
              ...
              items: [{
                        	...
                        	store : new Ext.data.SimpleStore({
                        		fields : ["returnValue", "displayText"],
                        			data : [['', '全部'],['手动式隔离开关', '手动式隔离开关'],['电动式隔离开关', '电动式隔离开关']]
                        	}),
                        	valueField : "returnValue",
                        	displayField : "displayText",
                        	mode : 'local',// 数据是在本地
       ...
       items : [{
                	...
                	items:[{xtype:'hidden',name:'ID'},{xtype:'hidden',name:'ID'},{
                		...
                		items: [{
                        	...
                        	emptyText : '选择选择线别',// 在没有选择值时显示为选择学历
                	...
                	items:[{
                		...
                		items: [{
                        	...
                        	store : new Ext.data.SimpleStore({
                        		...
                        		fields : ["returnValue", "displayText"],
                        		// 定义了几组数据.每组数据都是根据fiedls的定义来组成的，数组里第一个值就是retrunValue的值，第二个值就是displayText的值，例如[1,'小学']，就表示retrunValue是1，displayText是小学。
                        		data : [['手动式隔离开关', '手动式隔离开关'],['电动式隔离开关', '电动式隔离开关']]
                        	}),
                        	valueField : "returnValue",// 设置下拉选择框的值
                       		displayField : "displayText",// 设置下拉选择框的显示文本
                        	mode : 'local',// 数据是在本地
                        	//forceSelection : true,// 必须选择一个选项
                        	blankText : '请选择隔离开关类型',// 提交form时，该项如果没有选择，则提示错误信息"请选择学历"
                        	emptyText : '选择隔离开关类型',// 在没有选择值时显示为选择学历
                		...
                		items: [{
                        	...
                        	store : new Ext.data.SimpleStore({
                        		...
                        		fields : ["returnValue", "displayText"],
                        		// 定义了几组数据.每组数据都是根据fiedls的定义来组成的，数组里第一个值就是retrunValue的值，第二个值就是displayText的值，例如[1,'小学']，就表示retrunValue是1，displayText是小学。
                        		data : [['带接地刀闸', '带接地刀闸'],['不带接地刀闸', '不带接地刀闸']]
                        	}),
                        	valueField : "returnValue",// 设置下拉选择框的值
                       		displayField : "displayText",// 设置下拉选择框的显示文本
                        	mode : 'local',// 数据是在本地
                        	//forceSelection : true,// 必须选择一个选项
                        	blankText : '请选择是否带接地刀闸',// 提交form时，该项如果没有选择，则提示错误信息"请选择学历"
                        	emptyText : '选择是否带接地刀闸',// 在没有选择值时显示为选择学历
                	...
                	items:[{
                		...
                		items: [{
                        	...
                        	store : new Ext.data.SimpleStore({
                        		...
                        		fields : ["returnValue", "displayText"],
                        		// 定义了几组数据.每组数据都是根据fiedls的定义来组成的，数组里第一个值就是retrunValue的值，第二个值就是displayText的值，例如[1,'小学']，就表示retrunValue是1，displayText是小学。
                        		data : [['含流互', '含流互'],['不含流互', '不含流互']]
                        	}),
                        	valueField : "returnValue",// 设置下拉选择框的值
                       		displayField : "displayText",// 设置下拉选择框的显示文本
                        	mode : 'local',// 数据是在本地
                        	//forceSelection : true,// 必须选择一个选项
                        	blankText : '请选择是否含流互',// 提交form时，该项如果没有选择，则提示错误信息"请选择学历"
                        	emptyText : '选择是否含流互',// 在没有选择值时显示为选择学历
