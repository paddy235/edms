...
try {
	...
	String sql_Query_count="select count(*) from Z_YXGL_CMD_DZ jcwzy,J_GYJC_GQZD gq where jcwzy.sldwid=gq.gqdm and ltype='2' and "+whereclause;
	...
	String sql_Query="select * from (select rownum xh,temp.* from (select jcwzy.*,gq.gqmc from Z_YXGL_CMD_DZ jcwzy,J_GYJC_GQZD gq where jcwzy.sldwid=gq.gqdm  and ltype='2' and "+ whereclause +" order by flsj desc) temp) where xh between "+ (index+1) +" and "+ (pageSize + index);
