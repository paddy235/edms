...
try {
	...
	String sql_Query_count="select count(*) from Z_YXGL_CMD_DZ jcwzy,j_Gyjc_Ddtzd gq where jcwzy.sldwid=gq.ddtdm  and ltype='1' and (mlzt='1' or mlzt='2' or mlzt='3' or mlzt='1' ) and jhid='"+jhid+"'";
	...
	String sql_Query="select * from (select rownum xh,temp.* from (select jcwzy.*, gq.ddtmc as gqmc from Z_YXGL_CMD_DZ jcwzy,j_Gyjc_Ddtzd gq where jcwzy.sldwid=gq.ddtdm  and ltype='1' and  (mlzt='1' or mlzt='2' or mlzt='3' or mlzt='1' ) and jhid='"+jhid+"')temp) where xh between "+ (index+1) +" and "+ (pageSize + index);
