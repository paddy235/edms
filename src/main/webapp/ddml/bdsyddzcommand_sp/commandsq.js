Ext.onReady(function() {
   ...
   // var bds_mlh=document.getElementById("bds_mlh").value;
    ...
    //alert("zcvzxvc");
    ddtdm=userDwid;
     var ddtdm1=document.getElementById("ddtdm").value;//电调台代码
    var kpmc="";
    //alert(bds_mlh);
 	...
 	//渲染返回html代码
      	 ...
      	 var zt =function (value)
 	 {
 	 	...
 	 	{
 	 		return '<div  style="color:red;">审核通过</div>';
 	 	}
 	 			else if(value=="4")
 	 	{
   ...
   var sql_gq="select ddtdm as gqdm,ddtmc as gqmc from j_Gyjc_Ddtzd";//
   ...
   var sql_qjzc="select * from J_GYJC_QJZCZD";//
    ...
    //grid.render();//渲染表格
	 ...
	 // form start
        ...
        {header:'倒闸表',dataIndex:'GDB',width:60},
  ...
  //alert(record.get('mlzt'));
       ...
       simpleFormZy_Save.buttons[6].setVisible(false);
        ...
        simpleFormZy_Save.buttons[6].setVisible(true); 
        }
