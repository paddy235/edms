...
try {
  ...
  String sql_insert="insert into z_yxgl_cmd_glkgdz (commandid,dwid,dwmc,jhid,mlh,sldwid,sldwmc,qjzc,glkgh,dz,mlzt,yqwcsj) values(z_yxgl_cmd_glkgdzsquence.nextval,'"+dwid+"','"+dwid+"','"+jhid+"','"+(num_mlh+1)+"','"+sldwid+"','怀化变网工区','"+qjzc+"','"+glkgh+"','"+dz+"','1',to_date('"+yqwcsj+"','yyyy-mm-dd hh24:mi'))";
