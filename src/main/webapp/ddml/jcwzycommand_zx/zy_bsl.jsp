...
String slr =username;// request.getParameter("slr");
...
try {
   String sql_upd="update z_yxgl_cmd_jcwzy set  slsj=to_date('"+df.format(new Date())+"','yyyy-mm-dd hh24:mi') ,  xlsj=to_date('"+df.format(new Date())+"','yyyy-mm-dd hh24:mi') ,slr='"+slr+"',xlr='"+xlr+"',mlzt='-1' where commandid='"+commadid+"'";
