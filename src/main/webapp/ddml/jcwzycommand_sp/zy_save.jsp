...
try {
  ...
  String sql_insert="insert into z_yxgl_cmd_jcwzy (commandid,dwid,dwmc,jhid,mlh,sldwid,sldwmc,yqwcsj,flsj,mlnr,tdqd,mlbz,mlzt,ltype,bdb,flr,zybs) values(z_yxgl_cmd_glkgdzsquence.nextval,'"+ddtdm+"','"+ddtmc+"','"+jhid+"','"+mlh+"','"+sldwid+"','怀化变网工区',to_date('"+yqwcsj+"','yyyy-mm-dd hh24:mi'),to_date('"+flsj+"','yyyy-mm-dd hh24:mi'),'"+mlnr+"','"+tdqd+"','"+mlbz+"','1','1','"+GDB+"','"+flr+"','"+zybs+"')";
