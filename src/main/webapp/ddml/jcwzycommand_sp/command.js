    ...
    var columns = new Ext.grid.ColumnModel([
      ...
      //  {header:'消令时间',dataIndex:'xlsj',width:60,sortable:true},
       ...
       // {header:'消令人',dataIndex:'xlr',width:60,sortable:true},
         {header:'状态',dataIndex:'mlzt',width:60,fixed:true,renderer:zt,sortable:true,hidden:true}
  ...
  ///-----区间战场--------------------
   ...
   var sql_qjzc="select * from J_GYJC_QJZCZD";//
    ...
    var store_qjzc = new Ext.data.Store({
     ...
     store_qjzc.load();
       var sql_bds_GDB="select distinct zy.bdb,zy.bdb from z_yxgl_cmd_jcwzy zy where ltype='1'";//
