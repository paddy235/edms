...
try {
   String sql_upd="update z_yxgl_cmd_jcwzy set mlh='"+mlh+"', sldwid='"+sldwid+"',sldwmc='"+sldwid+"',yqwcsj=to_date('"+yqwcsj+"','yyyy-mm-dd hh24:mi'),flsj=to_date('"+flsj+"','yyyy-mm-dd hh24:mi'),pzsj=to_date('"+pzsj+"','yyyy-mm-dd hh24:mi'),flr='"+flr+"',mlnr='"+mlnr+"',tdqd='"+tdqd+"',mlbz='"+mlbz+"',bdb='"+GDB+"',zybs='"+zybs+"' where commandid='"+commadid+"'";
