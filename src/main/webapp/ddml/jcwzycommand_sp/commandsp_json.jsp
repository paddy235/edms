...
System.out.println("----------------------");
	...
	String sql_Query_count="select count(*)  from z_yxgl_cmd_bdsdz bdsdz ,J_GYJC_GQZD gq where   gq.gqdm=bdsdz.sldwid and (mlzt='1' or mlzt='2' or mlzt='3') and bdsdz.jhid="+jhid;
	...
	String sql_Query="select * from (select rownum xh,temp.* from (select bdsdz.*,gq.gqmc from z_yxgl_cmd_bdsdz bdsdz ,J_GYJC_GQZD gq  where   gq.gqdm=bdsdz.sldwid and (mlzt='1' or mlzt='2' or mlzt='3') and bdsdz.jhid='"+jhid+"' order by mllx desc,bdsdz.sldwid,bdsdz.sldwid)temp) where xh between "+ (index+1) +" and "+ (pageSize + index);
