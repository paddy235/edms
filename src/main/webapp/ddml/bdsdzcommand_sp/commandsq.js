   ...
   store_czkp.load();
    ...
    //grid.render();//渲染表格
	 ...
	 // form start
        ...
        {header:'完成时间',dataIndex:'wcsj',width:60,sortable:true},
        {header:'批准时间',dataIndex:'pzsj',width:60,sortable:true},
        //{header:'消令时间',dataIndex:'xlsj',width:60,sortable:true},
         {header:'发令人',dataIndex:'flr',width:60,sortable:true},
         {header:'受令人',dataIndex:'slr',width:60,sortable:true},
                                   ...
                                   items : [{
                                                ...
                                                //               store :store_czkp,
                                                 ...
                                                 //              displayField : "value",// 设置下拉选择框的显示文本
                                                  //             mode : 'local',// 数据是在本地
                                                               //forceSelection : true,// 必须选择一个选项
                                                   //            blankText : '选择操作卡片',// 提交form时，该项如果没有选择，则提示错误信息"请选择学历"
                                                   //            emptyText : '选择操作卡片',// 在没有选择值时显示为选择学历
                                                  //             hiddenName : 'czkah',// 大家要注意的是hiddenName和name属性，name只是下拉列表的名称，作用是可通过，而hiddenName才是提交到后台的input的name。如果没有设置hiddenName，在后台是接收不到数据的，这个大家一定要注意。
                                                   //            editable : false,// 该下拉列表只允许选择，不允许输入
                                                   //            triggerAction : 'all',// 因为这个下拉是只能选择的，所以一定要设置属性triggerAction为all，不然当你选择了某个选项后，你的下拉将只会出现匹配选项值文本的选择项，其它选择项是不会再显示了，这样你就不能更改其它选项了。
                                                    //           allowBlank : true,// 该选项值不允许为空
                                                    //           fieldLabel : '操作卡片',// 控件的标题是学历
                                                    //           id:'com_sldw',
