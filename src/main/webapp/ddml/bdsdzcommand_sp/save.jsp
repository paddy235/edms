...
try {
  ...
  String sql_insert="insert into Z_YXGL_CMD_DZ (commandid,dwid,dwmc,jhid,mlh,sldwid,sldwmc,wcsj,flsj,pzsj,mlnr,tdqd,mlbz,mlzt,ltype,bdb,flr,zybs,slr,slsj,xlr,xlnr) values(z_yxgl_cmd_glkgdzsquence.nextval,'"+ddtdm+"','"+ddtmc+"','"+jhid+"','"+mlh+"','"+sldwid+"','怀化变网工区',to_date('"+wcsj+"','yyyy-mm-dd hh24:mi'),to_date('"+flsj+"','yyyy-mm-dd hh24:mi'),to_date('"+pzsj+"','yyyy-mm-dd hh24:mi'),'"+mlnr+"','"+tdqd+"','"+mlbz+"','100','0','"+GDB+"','"+flr+"','"+zybs+"','"+slr+"',to_date('"+slsj+"','yyyy-mm-dd hh24:mi'),'"+xlr+"','"+xlnr+"')";
