...
try {
	...
	String sql_Query_count="select count(*) from Z_YXGL_CMD_DZ jcwzy,J_GYJC_GQZD gq where jcwzy.sldwid=gq.gqdm  and ltype='0' and (mlzt='1' or mlzt='2' or mlzt='3' or mlzt='4' ) and jcwzy.dwid='"+dwid+"'";
	...
	String sql_Query="select * from (select rownum xh,temp.* from (select jcwzy.*,gq.gqmc from Z_YXGL_CMD_DZ jcwzy,J_GYJC_GQZD gq where jcwzy.sldwid=gq.gqdm  and ltype='0' and  (mlzt='1' or mlzt='2' or mlzt='3' or mlzt='4') and jcwzy.dwid='"+dwid+"')temp) where xh between "+ (index+1) +" and "+ (pageSize + index);
    ...
    while(gridResultSet.next()){
		...
		json += "{commdid:" +gridResultSet.getLong("commandid")  + 
        		...
        		",wcsj:'"+ SetTime(gettime(gridResultSet.getDate("wcsj"))+" "+convertTime(gridResultSet.getTime("wcsj")))+"'"+
        	    ...
        	    ",GDB:'"+ SetNull(gridResultSet.getString("bdb"))+"'"+
