...
try {
   String sql_upd="update z_yxgl_cmd_jcwzy set slr='"+slr+"' ,xlr='"+xlr+"',xlsj=to_date('"+df.format(new Date())+"','yyyy-mm-dd hh24:mi'), slsj=to_date('"+df.format(new Date())+"','yyyy-mm-dd hh24:mi'),mlzt='-1' where commandid='"+commadid+"'";
   System.out.println("sql_upd：      "+sql_upd);
   dbTrade.executeUpdate(sql_upd);  
   dbTrade.close();
    out.print("{success:true,msg:'不受令成功！'}");
} 
