...
String xlr = session.getAttribute("userName").toString();//request.getParameter("xlr");
...
try {
   String sql_upd="update z_yxgl_cmd_jcwzy set xlsj=to_date('"+df.format(new Date())+"','yyyy-mm-dd hh24:mi'), xlr='"+xlr+"',xlnr='"+xlnr+"',mlzt='4' where commandid='"+commadid+"'";
