...
try {
   String sql_upd="update z_yxgl_cmd_jcwzy set mlh='"+mlh+"', sldwid='"+sldwid+"',sldwmc='"+sldwid+"',yqwcsj=to_date('"+yqwcsj+"','yyyy-mm-dd hh24:mi'),wcsj=to_date('"+wcsj+"','yyyy-mm-dd hh24:mi'),mlnr='"+mlnr+"',tdqd='"+tdqd+"',mlbz='"+mlbz+"',bdb='"+GDB+"' where commandid='"+commadid+"'";
