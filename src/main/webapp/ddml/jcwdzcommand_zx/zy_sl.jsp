...
try {
   //String sql_upd="update Z_YXGL_CMD_DZ set yqwcsj=to_date('"+yqwcsj+"','yyyy-mm-dd hh24:mi'),slr='"+slr+"',zybs='"+zybs+"',tdqd='"+tdqd+"',mlzt='3' where commandid='"+commadid+"'";
   String sql_upd="update Z_YXGL_CMD_DZ set mlzt='4' where commandid='"+commadid+"'";
   System.out.println("sql_upd：      "+sql_upd);
   dbTrade.executeUpdate(sql_upd);  
   dbTrade.close();
    out.print("{success:true,msg:'命令审核通过成功！'}");
} 
