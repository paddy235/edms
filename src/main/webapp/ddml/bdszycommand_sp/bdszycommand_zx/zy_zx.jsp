...
try {
   String sql_upd="update z_yxgl_cmd_jcwzy set wcsj=to_date('"+wcsj+"','yyyy-mm-dd hh24:mi'),slsj=to_date('"+slsj+"','yyyy-mm-dd hh24:mi'),xlsj=to_date('"+xlsj+"','yyyy-mm-dd hh24:mi'),slr='"+slr+"',xlr='"+xlr+"',mlzt='4' where commandid='"+commadid+"'";
