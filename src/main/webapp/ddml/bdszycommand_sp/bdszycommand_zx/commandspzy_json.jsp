...
try {
	...
	String sql_Query_count="select count(*) from z_yxgl_cmd_jcwzy jcwzy,J_GYJC_GQZD gq where jcwzy.sldwid=gq.gqdm  and ltype='0' and  (mlzt='2' or mlzt='3') and jhid='"+jhid+"'";
	...
	String sql_Query="select * from (select rownum xh,temp.* from (select jcwzy.*,gq.gqmc from z_yxgl_cmd_jcwzy jcwzy,J_GYJC_GQZD gq where jcwzy.sldwid=gq.gqdm  and ltype='0' and (mlzt='2' or mlzt='3') and jhid='"+jhid+"')temp) where xh between "+ (index+1) +" and "+ (pageSize + index);
